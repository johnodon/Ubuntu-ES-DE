...
#sudo apt install cmake build-essential libsdl2-dev libsdl2-gfx-dev libsdl2-ttf-dev libvorbis-dev libsdl2-image-dev autotools-dev --no-install-recommends -y    # uncomment this line if you plan to compile hypseus
